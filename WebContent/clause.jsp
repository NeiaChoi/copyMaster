      ...
      <form action="" id="joinForm">
        <ul class="join_box">
          ...
          <li class="checkBox check02">
            ...
            <textarea name="" id="">제1조(목적) 이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea>
          ...
          <li class="checkBox check03">
            ...
            <textarea name="" id="">1. 개인정보의 처리 목적 (‘사이트 URL’이하 ‘사이트명’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
- 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등


2. 개인정보의 처리 및 보유 기간

① (‘사이트 URL’이하 ‘사이트명’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.
...
① ('사이트 URL'이하 '사이트명')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② ('사이트 URL')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.


1.
- 개인정보를 제공받는 자 :
- 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호, 회사전화번호, 회사명
- 제공받는 자의 보유.이용기간: 1년
...
① ('사이트명')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

1.
- 위탁받는 자 (수탁자) :
- 위탁하는 업무의 내용 : 신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공
- 위탁기간 : 3년



② ('사이트 URL'이하 '사이트명')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.
...
① 정보주체는 KKOGI(‘사이트 URL’이하 ‘사이트명) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
1. 개인정보 열람요구
2. 오류 등이 있을 경우 정정 요구
3. 삭제요구
4. 처리정지
...
① ('사이트 URL'이하 '사이트명')은(는) 다음의 개인정보 항목을 처리하고 있습니다.

1<개인정보 처리업무>
- 필수항목 : 이메일, 휴대전화번호, 회사전화번호, 회사명
- 선택항목 : 이메일, 휴대전화번호, 회사전화번호, 회사명



7. 개인정보의 파기('사이트명')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
...
① KKOGI(‘사이트 URL’이하 ‘사이트명) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.

▶ 개인정보 보호책임자
성명 :KKOGI
직책 :대표
직급 :사장
연락처 :010-1111-2222, abc@naver.com, 063-222-3333
※ 개인정보 보호 담당부서로 연결됩니다.

▶ 개인정보 보호 담당부서
부서명 :총무과
담당자 :총무팀장
연락처 :010-555-6666, eee@naver.com, 063-444-5555
② 정보주체께서는 KKOGI(‘사이트 URL’이하 ‘사이트명) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. KKOGI(‘사이트 URL’이하 ‘사이트명) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
...
11. 개인정보의 안전성 확보 조치 ('사이트명')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
...
3. 문서보안을 위한 잠금장치 사용
개인정보가 포함된 서류, 보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고 있습니다.</textarea>
          </li>
        </ul>
        </br>
        <ul class="footBtwrap clearfix">
          <a class="btn gray" href="#gray">비동의</a>
          <a class="btn blue" href="#blue">동의</a>
        </ul>
      </form>
    </div>
